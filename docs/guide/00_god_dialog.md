...
regime-driver 的底层能力是强大的：编译流程、驱动 worker、进程外监督、报告复盘、并发隔离……
但如果使用它的代价是"先学会写 JSON 流程、记一堆命令参数、手工配置文件"，那这些能力对普通
使用者就形同虚设——没人愿意为了用工具先啃一本手册。

**上帝对话框的使命**：让使用者**时刻只需要和对话框对话**，就能做到 regime-driver 期望提供的
所有能力。复杂的配置书写、流程规划书写，由对话框替你完成。
