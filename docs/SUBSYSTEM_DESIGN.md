...
| 03 | [03_fleet](subsystems/03_fleet.md) | 并发隔离舰队 | `regime drive-many`，N 任务各自工作区并行全栈 |
...
| 06 | [06_god_dialog](subsystems/06_god_dialog.md) | 上帝对话框 | GodDialogUnit，对等状态机单元，对话控制面 |
| 07 | [07_god_dialog_carrier](subsystems/07_god_dialog_carrier.md) | 上帝对话框载体决策 | opencode 作载体（A 路）+ GodDialogUnit（B 路）+ CLI 契约 |
| 08 | [08_mock](subsystems/08_mock.md) | Mock 机制 | MockClient，无网络确定性调试 |
| 09 | [09_testing_architecture](subsystems/09_testing_architecture.md) | 测试架构 | E2E 系统化、god 容器、A 路打通 |
