...
| 章 | 文件 | 主题 | 说明 |
|----|------|------|------|
| 01 | [01_cli](reference/01_cli.md) | CLI 命令契约 | `regime` 全部子命令：run/run-many/drive/drive-many/flow/worker/chaos/validate/preflight/report/task/supervisor/session/sessions/job/dialog/doctor/scaffold/status/events/gate |
